...
<head>
    ...
    <title>Dashboard - Control de Riesgo</title>
    ...
    <style>
        ...
        .stat-card {
            background: linear-gradient(135deg, #8a70d6 0%, #6b52b3 100%);
            color: white;
        }
    </style>
</head>
            ...
            <div class="collapse navbar-collapse" id="navContent">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active"
                            href="{{ route('control-riesgo.index') }}">Inicio</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('control-riesgo.index') }}">Inspecciones</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('control-riesgo.reportes') }}">Reportes</a>
                    </li>
    ...
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col-12 text-center text-md-start">
                ...
                <p class="text-muted">Gestión de inspecciones y reportes de seguridad.</p>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        @foreach($openInspections as $draft)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('control-riesgo.inspecciones.edit', $draft->id) }}"
            ...
            <div class="col-md-8">
                <div class="card p-4 h-100 shadow-sm border-0">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="fw-bold m-0">Últimos Reportes</h5>
                        <a href="{{ route('control-riesgo.reportes') }}"
                            ...
                            <tbody>
                                @forelse($recentInspections as $ri)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('control-riesgo.reportes.show', $ri->id) }}"
                                                class="btn btn-sm btn-outline-primary">Ver Detalle</a></td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">No hay reportes finalizados.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
                ...
                @forelse($availableVersions as $version)
                    <div class="col-md-4">
                        <div class="card text-center p-4 border-0 shadow-sm hover-card">
                            ...
                            <a href="{{ route('control-riesgo.inspecciones.create', $version->id) }}"
