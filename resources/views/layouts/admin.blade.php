...
<head>
    ...
    <title>@yield('title', 'Administrador - ContainerCheck')</title>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.index') ? 'active' : '' }}"
                            href="{{ route('admin.index') }}">Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.forms.*') ? 'active' : '' }}"
                            href="{{ route('admin.forms.index') }}">Formularios</a>
                    </li>
                    <li class="nav-item">
